...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('d:\sign language proj\Sign_Aditya\cnn8grps_rad1_model.h5')
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread(r'd:\sign language proj\Sign_Aditya\white.jpg')
    ...
    def action1(self):
        ...
        self.speak_fun()
        time.sleep(5)
        subprocess.call(["python3", "test2.py"])
        print("ran successfully both scripts")
        self.clear_fun()
    ...
    def predict(self, test_image):
        ...
        if ch1 == 2:
            if self.distance(self.pts[12], self.pts[4]) > 42:
                ch1 = 'C'
            elif self.distance(self.pts[20], self.pts[4]) < 32:
                ch1= 'little'
            else:
                ch1 = 'O'
        ...
        if ch1 == 3:
            if (self.distance(self.pts[8], self.pts[12])) > 72:
                ch1 = 'G'
            elif (self.distance(self.pts[8], self.pts[12])) < 72:
                ch1 = 'Go'
            else:
                ch1 = 'H'
        if ch1 == 7:
            ...
            elif self.distance(self.pts[8], self.pts[14]) > 42:
                ch1 = 'PEACE'
            else:
                ch1 = 'J'
...
engine.say("Hello, Welcome to Sign Language Detection, Give Hand Gestures.")
